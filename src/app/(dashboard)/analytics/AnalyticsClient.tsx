...
function StatsShareCard() {
  ...
  return (
    <div className="bg-white border border-[rgba(11,18,32,0.08)] rounded-xl p-5">
      ...
      {/* Share buttons — colored icon-only */}
      <div className="flex gap-2.5 flex-wrap">
        <button
          ...
          className="flex items-center justify-center w-11 h-11 rounded-xl bg-black text-white hover:opacity-85 transition-opacity disabled:opacity-40"
        >
          <IconX />
        </button>
        <button
          ...
          className="flex items-center justify-center w-11 h-11 rounded-xl text-white hover:opacity-85 transition-opacity disabled:opacity-40"
        ...
        <button
          ...
          className="flex items-center justify-center w-11 h-11 rounded-xl text-white hover:opacity-85 transition-opacity disabled:opacity-40"
          style={{ background: copied === 'instagram' ? '#22c55e' : 'linear-gradient(135deg, #f58529 0%, #dd2a7b 50%, #8134af 100%)' }}
        >
          {copied === 'instagram' ? <Check className="h-5 w-5" /> : <IconInstagram />}
        </button>
        <button
          title="Copy link for Snapchat"
          disabled={!shareUrl}
          onClick={() => copyLink('snapchat')}
          className="flex items-center justify-center w-11 h-11 rounded-xl hover:opacity-85 transition-opacity disabled:opacity-40"
          style={{ backgroundColor: copied === 'snapchat' ? '#22c55e' : '#FFFC00', color: copied === 'snapchat' ? 'white' : '#1a1a1a' }}
        >
          {copied === 'snapchat' ? <Check className="h-5 w-5" style={{ color: 'white' }} /> : <IconSnapchat />}
        </button>
        <button
          title="Copy link"
          disabled={!shareUrl}
          ...
          className="flex items-center justify-center w-11 h-11 rounded-xl text-white hover:opacity-85 transition-opacity disabled:opacity-40"
          style={{ backgroundColor: copied === 'other' ? '#22c55e' : '#0b1220' }}
        >
          {copied === 'other' ? <Check className="h-5 w-5" /> : <Copy className="h-5 w-5" />}
        </button>
      </div>
